//  Represent a graph of your college campus using adjacency list /adjacency  matrix. Nodes should represent the various departments/institutes and  links should represent the distance between them. Find minimum  spanning tree Using Kruskal’s algorithm. 
...
{ 
    int count,k,v1,v2,i,j,tree[10][10],pos,parent[10];  int sum; 
    count=0; 
    k=0;
    sum=0; 
    ...
    {
        pos=minimum(tot_edges);  if(pos==-1) 
        break; 
        v1=G[pos].v1; 
        v2=G[pos].v2; 
        i=find(v1,parent); 
